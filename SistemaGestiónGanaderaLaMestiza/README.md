...
Este proyecto ahora trabaja sobre el script base nuevo:

1. Ejecute en Oracle **Scripts/scripts/granja_lbd_final_1.sql**.
2. Luego ejecute el parche incremental **Scripts/scripts/V2026_04_14_001_auth_patch.sql** para asegurar la columna `clave` en `usuarios`.
3. Con eso, el registro guarda el hash de la contraseña (BCrypt) y el login la valida.
